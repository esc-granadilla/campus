...
class CreateAsignacionCursoProfesorsTable extends Migration
{
   ...
   public function up()
   {
      Schema::create('asignacion_curso_profesors', function (Blueprint $table) {
         $table->increments('id');
         ...
         $table->unique(['profesor_id', 'curso_id', 'horario_id', 'grado_id', 'dia_id'], 'asignacion_curso_profesors_primary');
   ...
   {
      Schema::dropIfExists('asignacion_curso_profesors');
   }
}
